...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://pat:pat@localhost:5433/news' #journal'
...
STEMMERS = defaultdict(lambda: 'english')
...
class_weight = {}
count_vector = MarisaCountVectorizer(ngram_range=(1, 2), min_df=1, max_df=0.90, stop_words='french')
...
def classifier_learn():
    ...
    if learning != Learn.LEARNING:
        ...
        try:
            ...
            x_train = tfidf_transformer.transform(x_new_counts)
